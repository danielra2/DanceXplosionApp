...
// Date statice pentru orar (Salsa, Bachata, Kizomba)
const scheduleData = [
...
function ScheduleTable() {
    // Gruparea claselor pe zile pentru afișare mai ușoară
    ...
    return (
        <section className="schedule-section">
            ...
            <div className="schedule-cta-wrapper">
                <button className="cta-schedule-register">Înscrie-te la O Clasă de Proba</button>
            </div>
        </section>
    );
}
